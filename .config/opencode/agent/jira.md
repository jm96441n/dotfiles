...
tools:
  ...
  # Bash - for acli commands, git operations, and formatting
  bash: true

  # Web access for fetching Jira links
  webfetch: true

  # Task delegation to other agents (e.g., explore agent for codebase searches)
  task: true

  # Skill access for acli
  skill: true

  # Disable local file modifications - keep focused on Jira operations
  write: false
  edit: false
  todowrite: false
...
5. Loop through and create issues one by one using acli jira workitem create
